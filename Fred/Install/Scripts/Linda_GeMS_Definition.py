...
'MapUnitPolys':             [['MapUnit','String','NoNulls',mapUnitLength],
                             ...
                             ['Symbol','String','NullsOK',IDLength],
...
'ContactsAndFaults':        [['Type','String','NoNulls',defaultLength],
                             ...
                             ['AuthorLocationConfidence','String','NoNulls',IDLength],
                             ['Label','String','NullsOK',IDLength],
                             ['Symbol','String','NullsOK',defaultLength],
                             ['DataSourceID','String','NoNulls',IDLength],
                             ['DataSourceID2','String','NoNulls',IDLength],
...
# Feature classes used by the Idaho Geological Survey
# Definitions copied from GenericPoints and needs to be modified

'GeochemPoints':            [['Type','String','NoNulls',defaultLength],
                             ['Symbol','String','NullsOK',defaultLength],
                             ['Label','String','NullsOK',IDLength],
                             ['LocationConfidenceMeters','Single','NoNulls'],
                             ['PlotAtScale','Single','NoNulls'],
...
'GeologicPoints':            [['Type','String','NoNulls',defaultLength],
                             ['Symbol','String','NullsOK',defaultLength],
                             ['Label','String','NullsOK',IDLength],
                             ['LocationConfidenceMeters','Single','NoNulls'],
                             ['PlotAtScale','Single','NoNulls'],
